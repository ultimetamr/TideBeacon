...
> artifactRevision: 10｜v3 clean baseline｜active interaction@17｜approved D1
...
v3 Stage 08 revalidation: D1 quiet low-poly nocturne selected by structured effect review；D2/D3 rejected for hierarchy/comfort conflicts；no template reuse.
v3 Stage 11 baseline revalidation: C1–C7 authoritative eight-segment contracts, A/B/C coverage, global motion/material/text semantics and stable overlay precedence rebuilt against active interaction@17.
